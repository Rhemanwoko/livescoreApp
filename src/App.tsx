...
const HomePage = ({ onNavigate, standings, scorers }: HomePageProps) => {
...
const TeamsPage = ({ onNavigate, teams }: TeamsPageProps) => {
  return (
    <div className="space-y-6">
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="text-right text-sm text-slate-400 md:text-left">
          <p>Snapshot generated from curated mock data</p>
        </div>
      </div>
      ...
      <section className="glass-card p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <span className="text-sm text-slate-400">Mocked player overview for this build</span>
        </div>
...
const AboutPage = () => (
  <section className="glass-card space-y-6 p-8">
    ...
    <p className="text-slate-300">
      Live-style tables, leaderboards and club hubs are fuelled by handcrafted mock data so the
      dashboard always renders reliably. The analytics cards stick around to show how richer visuals
      slot into the layout.
    </p>
...
const Footer = () => (
  <footer className="mt-16 flex flex-col items-center gap-3 text-xs text-slate-500 md:flex-row md:justify-between">
    <p>Premier League Live Dashboard · Demo data curated for this build</p>
    <p>
      Built with ⚽ by{' '}
...
const App = () => {
  ...
  const teamDetails = mockTeamDetails
  ...
  return (
    <div className="app-shell space-y-10">
      ...
      <main className="space-y-12">
        {route.page === 'home' && (
          <HomePage onNavigate={onNavigate} standings={standings} scorers={scorers} />
        )}
        {route.page === 'teams' && <TeamsPage onNavigate={onNavigate} teams={teams} />}
        {route.page === 'team' && (
