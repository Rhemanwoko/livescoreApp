  ...
  <nav className="flex flex-wrap gap-3">
    {navigation.map((item) => {
      const active =
        ...
        item.label.toLowerCase() === current;
      return (
        <button
          key={item.path}
          type="button"
        ...
        <div className="gradient-inner grid gap-6 md:grid-cols-[auto_minmax(0,1fr)]">
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
              <div>
                <h2 className="page-title text-4xl font-bold text-white">
                  {team.name}
                </h2>
                <p className="text-sm uppercase tracking-[0.35em] text-slate-500">
                  {team.venue}
    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-slate-300">
            A quick analytics pass covering attacking output, efficiency and
            five-match momentum.
          </p>
        </div>
        <button
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <div className="glass-card p-6">
          ...
          <p className="text-sm text-slate-400">
            Bar length scaled to the league&apos;s top attack.
          </p>
        ...
        <div className="glass-card p-6">
          ...
          <p className="text-sm text-slate-400">
            Victories after nine games compared to the leaders.
          </p>
          <div className="mt-5 space-y-4">
            {attackingStats.map((club) => (
      ...
      <section className="glass-card p-6">
        ...
        <p className="text-sm text-slate-400">
          Form translated to points-per-match (W=3, D=1) over the last five
          fixtures.
        </p>
...
const AboutPage = () => (
  <section className="glass-card space-y-6 p-8">
    ...
    <p className="text-slate-300">
      I love pairing clean data visualisation with compelling football
      storytelling. This dashboard was crafted with React 19, Tailwind (via
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div className="space-y-3">
            ...
            <h1 className="page-title text-4xl font-bold text-white md:text-5xl">
              Premier League Live Centre
            </h1>
            <p className="max-w-2xl text-slate-300">
              Live standings, fixtures, player contributions and momentum charts
              — all in one clean dashboard built for matchday.
            </p>
          </div>
